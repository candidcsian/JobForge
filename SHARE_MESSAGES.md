...
- Creating ATS-optimized resume (Word format)
...
The tool will ask you questions about your career...

[Show the interactive prompts]

And it generates:
- ATS-optimized resume in Word format
...
**Title**: Built a tool that creates ATS-optimized resumes in 2 hours
...
- Generates ATS-optimized resume (Word format)
- Creates LinkedIn profile content
...
**Title**: Free tool to build your resume in 2 hours
